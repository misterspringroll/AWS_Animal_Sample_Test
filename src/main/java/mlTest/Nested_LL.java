...
public class Nested_LL {
	...
	public static class MyQType {
        ...
        protected void add(int A_Num_count, String txt_Question, String txt_Answer, String Q_Type, int Q_count, int A_count) {
        	MyQType temp = this;
        	if (this.get_question_type() == null)
        	{
        		this.question_type = Q_Type;
        		this.QA_deposit = new LinkedList<QA_deposit>();
        		QA_deposit temp_QA = new QA_deposit(A_Num_count,txt_Question,txt_Answer,Q_count,A_count);
        	...
        	{
        		temp.next.add(A_Num_count, txt_Question, txt_Answer, Q_Type, Q_count, A_count);
        	}
        }
	...
	public static class MyNode {
        ...
        public void add(int A_Num_count, String txt_Question, String txt_Answer, String Q_Type, int Q_count, int A_count, String txt_Subject) {
    		MyNode temp = this;
        	if (this.get_animal_name() == null)
        	{
        		this.animal_name = txt_Subject;
        		this.ll_deposit = new MyQType();
	            this.get_ll().add(A_Num_count,txt_Question,txt_Answer,Q_Type,Q_count,A_count);
	            this.next = new MyNode();
	            return;
        	}
        	else if(temp.get_animal_name().contains(txt_Subject))
        	{
        		temp.get_ll().add(A_Num_count,txt_Question,txt_Answer,Q_Type,Q_count,A_count);
        	}
        	else
        	{
        		temp.next.add(A_Num_count, txt_Question, txt_Answer, Q_Type, Q_count, A_count, txt_Subject);
        	}
        }
